  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gray-50/50 flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-xs font-black text-primary uppercase tracking-widest">Loading Property Data...</p>
      </div>
    );
  }
              ...
              >
                ...
                {currentStep === 1 && (
                  <div className="space-y-8">
                    <div>
                      <h2 className="text-3xl font-black text-gray-900 tracking-tight">Edit your listing</h2>
                      <p className="text-gray-500 font-medium mt-1">Update the basic information of your property.</p>
                    </div>
                ...
                {currentStep === 2 && (
                  <div className="space-y-8">
                    <div>
                      ...
                      <p className="text-gray-500 font-medium mt-1">Update the configuration and layout.</p>
                    </div>
                ...
                {currentStep === 3 && (
                  <div className="space-y-8">
                    <div>
                      ...
                      <p className="text-gray-500 font-medium mt-1">Review your pricing and photos.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      <div className="md:col-span-2">
                        <div className="border-2 border-dashed border-gray-200 rounded-[32px] p-12 text-center hover:border-primary hover:bg-primary/5 transition-all cursor-pointer group">
                          ...
                          <h4 className="font-black text-gray-900 text-lg">Update Photos</h4>
                          <p className="text-gray-400 text-sm font-medium mt-1">Current images will be preserved</p>
                        </div>
                      </div>
                ...
                <div className="flex items-center justify-between pt-10 border-t border-gray-50">
                  ...
                  {currentStep < STEPS.length ? (
                    ...
                    <button
                      ...
                      className="bg-[#0041C2] text-white font-black px-10 py-4 rounded-2xl flex items-center gap-3 shadow-xl shadow-blue-600/20 hover:scale-105 transition-all uppercase text-[10px] tracking-widest disabled:opacity-50"
                    >
                      {isSubmitting ? "Updating..." : "Save Changes"} <ShieldCheck size={16} />
                    </button>
                  )}
                </div>
              </motion.div>
